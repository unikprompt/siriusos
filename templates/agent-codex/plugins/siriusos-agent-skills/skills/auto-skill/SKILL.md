...
3. **Existing skill**: Does a skill for this already exist in `plugins/siriusos-agent-skills/skills/`? If yes, stop — consider proposing a patch instead.
...
- [ ] No skill with this name exists in `plugins/siriusos-agent-skills/skills/`
...
mv skills/drafts/[skill-name]/ plugins/siriusos-agent-skills/skills/[skill-name]/

# Update status field
sed -i '' 's/status: draft/status: active/' plugins/siriusos-agent-skills/skills/[skill-name]/SKILL.md
...
| active | `plugins/siriusos-agent-skills/skills/[name]/SKILL.md` | Yes |
