...
```bash
siriusos bus add-cron $CTX_AGENT_NAME experiment-<metric> <loop_interval> "Read plugins/siriusos-agent-skills/skills/autoresearch/SKILL.md and execute the experiment loop."
```
