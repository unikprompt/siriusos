...
```bash
siriusos bus update-heartbeat "<1-sentence summary of current work>"
```
...
Full reference: `plugins/siriusos-agent-skills/skills/comms/SKILL.md`
...
If any of those messages were Telegram-shape (`=== TELEGRAM from`), you should already have replied via `siriusos bus send-telegram` when they first arrived — if not, do it NOW before continuing.

## Step 3: Check task queue + stale task detection

Full reference: `plugins/siriusos-agent-skills/skills/tasks/SKILL.md`
...
Full reference: `plugins/siriusos-agent-skills/skills/event-logging/SKILL.md`
...
Full reference: `plugins/siriusos-agent-skills/skills/memory/SKILL.md`
...
- If goals were updated today: you should already have tasks. If not, create them now — see `plugins/siriusos-agent-skills/skills/tasks/SKILL.md`
...
If you are blocked, see `plugins/siriusos-agent-skills/skills/human-tasks/SKILL.md` for the human task and approval workflow.
If you need an approval before acting, see `plugins/siriusos-agent-skills/skills/approvals/SKILL.md`.

## Step 8: Guardrail self-check

Full reference: `plugins/siriusos-agent-skills/skills/guardrails-reference/SKILL.md`
...
Full reference: `plugins/siriusos-agent-skills/skills/knowledge-base/SKILL.md`
